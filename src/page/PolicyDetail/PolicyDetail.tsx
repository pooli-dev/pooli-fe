...
const PolicyDetail = () => {
  ...
  const [selectedMember, setSelectedMember] = useState<FamilyMember>(familyMembers[1]);
  ...
  // 앱 정책 상태 관리
  const [appPolicyStates, setAppPolicyStates] = useState<AppPolicy[]>(appPolicies);
    ...
    <>
      ...
      <header className="fixed top-6 left-1/2 -translate-x-1/2 w-[480px] max-w-full flex justify-between items-center px-5 h-20 pt-[env(safe-area-inset-top)] z-[100]">
        ...
        <div className="flex-1 flex justify-center items-center">
          <h1 className="font-semibold text-[#333333] m-0" style={{ fontSize: '1.25em' }}>구성원 별 정책 제어</h1>
        </div>
      ...
      <div className="relative h-[calc(100vh-106px-60px)] overflow-y-auto mt-[106px] mb-[60px]">
        <div className="px-[24px] py-5 pb-[60px]">
          {/* 사용자 선택 */}
          <div className="mb-6">
            <h3 className="font-semibold text-[#333333] mb-4" style={{ fontSize: '1.125em' }}>사용자 선택</h3>
            ...
            {familyMembers.map((member) => (
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor: member.lineId === 10 
                      ? '#FBC7C3' 
                      : member.lineId === 11 
                        ? '#CAA6DB' 
                        : member.lineId === 12 
          ...
          <div className="mb-6">
            ...
            policies={appliedPolicies.map(policy => ({
              id: policy.policyId,
              type: policy.policyType === "BLOCK" ? "한도" : policy.policyType === "LIMIT" ? "한도" : "시간",
              bgColor: policy.policyType === "BLOCK" ? "#FFE5E5" : policy.policyType === "LIMIT" ? "#E5F5E5" : "#E5E5FF",
