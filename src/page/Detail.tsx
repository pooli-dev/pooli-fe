    ...
    <div className="relative h-[calc(100vh-106px-100px)] overflow-y-auto mt-[106px] mb-[100px]">
      <div className="px-5 py-5">
        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              <rect x="3" y="4" width="18" height="18" rx="2" stroke="#678BF7" strokeWidth="2"/>
        ...
        {/* 날짜 선택 모달 */}
        {showDatePicker && (
          <div className="fixed inset-0 bg-black/50 z-[300] flex items-center justify-center" onClick={() => setShowDatePicker(false)}>
        ...
        {/* 데이터 잔여량 */}
        <div ref={dataRef} className="bg-white rounded-2xl p-5 shadow-sm mb-6">
          <h3 className="font-semibold text-[#333333] mb-4" style={{ fontSize: '1.125em' }}>데이터 잔여량</h3>
        ...
        {/* 최근 3개월간 사용량 추이 */}
        <div className="bg-white rounded-2xl p-5 shadow-sm mb-6">
          <h3 className="font-semibold text-[#333333] mb-4" style={{ fontSize: '1.125em' }}>최근 3개월간 사용량 추이</h3>
        ...
        {/* 앱 서비스별 사용량 */}
        <div ref={chartRef} className="bg-white rounded-2xl p-5 shadow-sm mb-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-[#333333]" style={{ fontSize: '1.125em' }}>앱 서비스별 사용량</h3>
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center justify-center mb-8">
                <div className="relative w-64 h-64" style={{ filter: 'drop-shadow(0 2px 8px rgba(0, 0, 0, 0.1))' }}>
                  ...
                  {hoveredAppIndex !== null && (
                    <div 
                      className="absolute top-4 left-1/2 -translate-x-1/2 bg-[#333333] text-white px-3 py-1.5 rounded text-sm font-medium z-30 whitespace-nowrap"
                    >
                      {appNameMap[appUsage.apps[hoveredAppIndex].appName] || appUsage.apps[hoveredAppIndex].appName}: {(appUsage.apps[hoveredAppIndex].usedAmount / 1000).toFixed(1)}GB
                  ...
                  <svg className="w-full h-full -rotate-90" viewBox="0 0 256 256">
                    {(() => {
                      ...
                      return appUsage.apps.map((app, index) => {
                        ...
                        const dashOffset = -appUsage.apps.slice(0, index).reduce((sum, a) => sum + (a.usedAmount / total) * circumference, 0);
                        ...
                        return (
                          <g key={index}>
                            <circle
                              ...
                              strokeDashoffset={chartAnimated ? dashOffset : -circumference}
              ...
              <div className="space-y-3 px-6">
                {appUsage.apps.map((app, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full" style={{ backgroundColor: appColor }}></div>
                        <span className="text-[#333333]" style={{ fontSize: '1em' }}>{appNameKo}</span>
                      </div>
